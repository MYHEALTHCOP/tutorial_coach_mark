...
class TutorialCoachMarkWidget extends StatefulWidget {
  ...
  })  : assert(titles.length == descriptions.length && titles.length == targetKeys.length && targetKeys.length > 0),
        super(key: key);
      ...
      child: Stack(
        children: <Widget>[
          AnimatedFocusLight(
            ...
            targetKeys: widget.targetKeys,
            titles: widget.titles,
            close: widget.close,
            descriptions: widget.descriptions,
            aligns: widget.aligns,
            targetShapes: widget.targetShapes,
            clickTarget: (target) {
